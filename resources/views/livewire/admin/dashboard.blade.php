            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white  p-6 rounded-lg shadow-md dark:bg-gray-800">
                        ...
                        <p class="mt-2 text-3xl font-bold text-gray-900 dark:text-white">{{ $jumlahKamarTersedia }} /
                            {{ $jumlahKamarTotal }}</p>
                    </div>
                    <div class="bg-white  p-6 rounded-lg shadow-md dark:bg-gray-800">
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Jumlah Kamar Tersewa</h3>
                        <p class="mt-2 text-3xl font-bold text-gray-900 dark:text-white">{{ $jumlahKamarTersewa }} /
                            {{ $jumlahKamarTotal }}</p>
                    </div>
                    <div class="bg-white  p-6 rounded-lg shadow-md dark:bg-gray-800">
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Jumlah Properti</h3>
                        <p class="mt-2 text-3xl font-bold text-gray-900 dark:text-white">{{ $jumlahProperti }} </p>
                    </div>
                    {{-- <div class="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800">
