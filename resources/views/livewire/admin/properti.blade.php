                                ...
                                <div class="border-t pt-4 flex items-center justify-between">
                                    ...
                                    <div class="flex space-x-3">
                                        ...
                                        <button wire:click="confirmDelete({{ $item->id }})"
                                            class="text-sm text-red-500 hover:text-red-700">Hapus</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    @empty
                        <div class="md:col-span-2 lg:col-span-3">
                            <div
                                ...
                                <svg class="mx-auto h-12 w-12 text-gray-400 dark:text-white" fill="none"
                                    stroke="currentColor" ...>...</svg>
                                <h3 class="mt-2 text-lg font-medium text-gray-900 dark:text-white">Belum Ada Properti
                                </h3>
                                <p class="mt-1 text-sm text-gray-500 dark:text-white">Mulailah dengan mendaftarkan kos
                                    atau apartemen
                                    Anda.</p>
                                <div class="mt-6">
                                    <button wire:click="create"
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900">Hapus Properti</h3>
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">
                                            Apakah Anda yakin ingin menghapus properti ini? Tindakan ini tidak dapat
                                            dibatalkan.
                                        </p>
                                    </div>
                                </div>
